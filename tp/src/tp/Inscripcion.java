...
public class Inscripcion {
	...
	private Map<Integer, Ciudadano> inscripciones;
	private ArrayList<Ciudadano> listaSinTurnoPrioritariaOrdenada;
	private ArrayList<Ciudadano> listaConTurnosOrdenada;
	...
	public ArrayList<Ciudadano> obtenerListadoConTurnosPorFecha(Fecha f, int cantPacientesPorDia) {
		//
		//
		//
		//
	...
	public String toString() {
		return "Inscripcion [inscripciones=" + inscripciones + ", listaSinTurnoPrioritariaOrdenada="
